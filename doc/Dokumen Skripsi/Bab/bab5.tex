...
Kelompok kedua terdiri dari empat orang mahasiswa diluar jurusan teknik
...
\subsubsection{Perbandingan Rata-Rata Waktu Pengujian}
...
\begin{tikzpicture}
    \begin{axis}[
        ...
        bar width=14pt,
        ymajorgrids = true,
        ylabel = {Rata-rata waktu pengujian (detik)},
        symbolic x coords={Kelompok Pertama,Kelompok Kedua},
        xtick = data,
        ...
        \addplot
            coordinates {(Kelompok Pertama, 94.25) (Kelompok Kedua,128.25)};

        \addplot
             coordinates {(Kelompok Pertama, 14.25) (Kelompok Kedua,63.75)};

        \addplot
             coordinates {(Kelompok Pertama, 15.25) (Kelompok Kedua,44.5)};

        \addplot
             coordinates {(Kelompok Pertama, 36) (Kelompok Kedua,68.75)};
        
        \addplot
             coordinates {(Kelompok Pertama, 16.25) (Kelompok Kedua,74.75)};

        \addplot
             coordinates {(Kelompok Pertama, 104.25) (Kelompok Kedua,133.75)};

        \legend{Login,Melihat Daftar Mahasiswa,Melihat Info Mahasiswa,Mengedit
        Info Mahasiswa,Melihat Histori Mahasiswa,Membuat Entri Baru}
    \end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot
            coordinates {(Kelompok Pertama, 29) (Kelompok Kedua,30)};

        \addplot
             coordinates {(Kelompok Pertama, 37) (Kelompok Kedua,37)};

        \addplot
             coordinates {(Kelompok Pertama, 39) (Kelompok Kedua,35)};

        \addplot
             coordinates {(Kelompok Pertama, 38) (Kelompok Kedua,36)};
        
        \legend{Responden 1,Responden 2,Responden 3,Responden 4}
    \end{axis}
\end{tikzpicture}
\caption[Diagram Perbandingan Total Nilai Kuesioner Setiap Responden]{Diagram
Perbandingan Total Nilai Kuesioner Setiap Responden}
\label{fig:diagramperbandinganhasilkuesionersetiapresponden}
\end{figure}

Total dari nilai kuesioner yang dimiliki kedua kelompok berdasarkan Gambar
\ref{fig:diagramperbandinganhasilkuesionersetiapresponden} tidak memiliki
perbedaan yang signifikan. Hal tersebut membuktikan kedua kelompok sangat setuju
dengan kinerja, akurasi dan kemudahan dalam menggunakan SIRM.
...
Berdasarkan Tabel \ref{tab:ratanilaikuesionerkeduakelompok} data rata-rata nilai
