...
\begin{figure}[p]
\centering
\includegraphics[scale=0.5]{Gambar/tipeaplikasi.png}
...
\begin{figure}[p]
\centering
\includegraphics[scale=0.5]{Gambar/tipeaplikasisudahdiisi.png}
...
dibangun. Sesuai landasan teori pada Sub Bab~\ref{sec:zurbfoundation}, pada
aplikasi ini menggunakan dua bagian yaitu {\it Grid} dan Tombol. {\it Grid}
digunakan untuk mengatur pembagian tata letak komples sehingga terlihat rapih.
Tombol digunakan untuk merubah tombol yang biasa menjadi lebih enak untuk
dilihat. Berikut sintaks penggunaan {\it Grid} dan Tombol pada list.php dan
untuk gambar dapat dilihat pada Gambar \ref{fig:contohzurb}.
...
\item Untuk {\it use case} Melihat Info Mahasiswa, skenarionya dapat dilihat pada
...
\item Untuk {\it use case} Edit Mahasiswa, skenarionya dapat dilihat pada Tabel
